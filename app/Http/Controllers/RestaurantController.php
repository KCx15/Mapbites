...
class RestaurantController extends Controller
{
    ...
    public function edit(\App\Models\Restaurant $restaurant)
    {
        ...
        public function update(Request $request, \App\Models\Restaurant $restaurant)
        {
            ...
            $addressChanged = trim($validated['address']) !== trim((string) $restaurant->address);
            ...
            if ($addressChanged) {
                ...
                $validated['lat'] = $geo['lat'];
                $validated['lng'] = $geo['lng'];
                $matchedAddress = $geo['display_name'] ?? null;
            } else {
                $coordsMissing = empty($validated['lat']) || empty($validated['lng']);
            ...
            $redirect = redirect()->route('restaurants.index')
                ->with('success', 'Restaurant updated successfully.');

            if ($matchedAddress) {
                $redirect->with('matched_address', $matchedAddress);
            }
